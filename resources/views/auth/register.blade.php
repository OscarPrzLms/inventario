            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="aPaterno" class="col-md-4 col-form-label text-md-end">{{ __('Primer apellido') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="aMaterno" class="col-md-4 col-form-label text-md-end">{{ __('Segundo apellido') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                               {{--  <input id="perfil" type="text" class="form-control @error('perfil') is-invalid @enderror" name="perfil" value="{{ old('perfil') }}" required autocomplete="perfil" autofocus> --}}
                                ...
                                <select name="perfil" id="perfil" class="form-control @error('perfil') is-invalid @enderror" required autofocus>
